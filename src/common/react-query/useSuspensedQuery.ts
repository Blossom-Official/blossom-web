...
export interface UseSuspenseQueryResultOnSuccess<TData>
...
export interface UseSuspenseQueryResultOnLoading
  extends BaseUseSuspenseQueryResult {
  data: undefined;
  isLoading: true;
  isSuccess: false;
  status: "loading";
 ...
 * @see {@link https://github.com/suspensive/react/blob/main/packages/react-query/src/useSuspenseQuery.ts Suspensive Source Code}
 */
